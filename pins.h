...
#define DECTECTIE_PIN       44

#define DETECTIE_DEUR_PIN  45
...
#define LED_PIN            13
#define FAN_PIN            10   // Gewisseld met Bed heater
#define PS_ON_PIN          -1
#define KILL_PIN           -1
#define SOL1_PIN   16
#define SOL2_PIN    7  // van 17 naar 7 ivm andere mosfet, in plaats van fan

#define HEATER_0_PIN       9
#define HEATER_1_PIN       8 // 12 (8)
#define HEATER_2_PIN       -1 // 13
#define TEMP_0_PIN         13 //D27   // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!!
#define TEMP_1_PIN         15 // 1
#define TEMP_2_PIN         -1 // 2
#define HEATER_BED_PIN     6 // 14/15   (Was 10, FAN zit daar nu op)
